...
| **VEIN_MGMT_CONTROLLER** | Points to `Controller/`, where all Python logic lives (`start_server.py`, `utils.py`, etc.). |
| **VEIN_CONFIG** | Absolute path to the active configuration file (`Config/config.json`). |
